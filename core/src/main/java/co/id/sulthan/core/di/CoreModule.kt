package co.id.sulthan.core.di

import androidx.room.Room
import co.id.sulthan.core.data.mapper.local.AyatEntityMapper
import co.id.sulthan.core.data.mapper.remote.ItemAyatMapper
import co.id.sulthan.core.data.repository.AyatRepositoryImpl
...
import co.id.sulthan.core.data.repository.SuratRepositoryImpl
import co.id.sulthan.core.data.source.local.room.QuranDatabase
